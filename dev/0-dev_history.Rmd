...
fusen::fill_description(
  ...
  fields = list(
    ...
    Description = "A collection of functions used by Find Biobank team",
    `Authors@R` = c(
      person("Moses", "Mburu", email = "moses.mburu@finddx.org", role = c("aut", "cre"), comment = c(ORCID = "0000-0001-7281-583X"))
    )
  )
)
