...
```{r function-select_and_shuffle_dt}
...
#' @param over_write A Logical value	If TRUE, overwrite any existing file
#' 
#' @return Writes file to provided path.
#' @importFrom openxlsx createWorkbook addWorksheet writeData saveWorkbook
#' @importFrom data.table setDF
#'
#' @export
create_save_workbook  <- function(list_of_dfs, path_name, sheet_names, over_write = FALSE) {
  ...
  # Save the workbook
  saveWorkbook(wb, file = path_name, overwrite = over_write)
